...
$app->post('/uploadpublicpost', function ( $request,  $response,  $args) {
    include __DIR__ .'/../bootstrap/dbconnection.php';
    ...
    $query = $pdo->prepare("INSERT INTO `publicposts` (`post`,`postUserId`,`statusImage`, `statusTime`)
                            VALUES (:post,:postUserId,:statusImage, current_timestamp); ");      
